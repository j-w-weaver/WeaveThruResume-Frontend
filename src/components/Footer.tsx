  ...
  return (
    <footer className="app-footer">
      <div className="footer-content">
        <div className="footer-section">
          <div className="footer-brand">
            <div className="footer-logo">
              <div className="footer-icon">W</div>
              <span>WeavThru</span>
            </div>
        ...
        <div className="footer-section">
          ...
          <ul>
            ...
            <li>
              <a onClick={() => navigate("/resumes")}>My Resumes</a>
            </li>
            <li>
              <a onClick={() => navigate("/analyses")}>Analyses</a>
            </li>
          </ul>
        </div>
      ...
      <div className="footer-bottom">
        <p>&copy; {currentYear} WeavThru. All rights reserved.</p>
